namespace MyCompanyName.AbpZeroTemplate.Authorization
{
    ...
    public static class AppPermissions
    {
        ...
        public const string Pages_ProjectStatus = "Pages.ProjectStatus";
        public const string Pages_ProjectStatus_Create = "Pages.ProjectStatus.Create";
        public const string Pages_ProjectStatus_Edit = "Pages.ProjectStatus.Edit";
        public const string Pages_ProjectStatus_Delete = "Pages.ProjectStatus.Delete";

        public const string Pages_ProjectIndustries = "Pages.ProjectIndustries";
        public const string Pages_ProjectIndustries_Create = "Pages.ProjectIndustries.Create";
        public const string Pages_ProjectIndustries_Edit = "Pages.ProjectIndustries.Edit";
        public const string Pages_ProjectIndustries_Delete = "Pages.ProjectIndustries.Delete";
