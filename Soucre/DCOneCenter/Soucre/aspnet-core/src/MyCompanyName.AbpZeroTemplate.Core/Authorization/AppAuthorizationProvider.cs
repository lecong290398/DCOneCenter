...
namespace MyCompanyName.AbpZeroTemplate.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            var projectStatus = pages.CreateChildPermission(AppPermissions.Pages_ProjectStatus, L("ProjectStatus"));
            projectStatus.CreateChildPermission(AppPermissions.Pages_ProjectStatus_Create, L("CreateNewProjectStatu"));
            projectStatus.CreateChildPermission(AppPermissions.Pages_ProjectStatus_Edit, L("EditProjectStatu"));
            projectStatus.CreateChildPermission(AppPermissions.Pages_ProjectStatus_Delete, L("DeleteProjectStatu"));

            var projectIndustries = pages.CreateChildPermission(AppPermissions.Pages_ProjectIndustries, L("ProjectIndustries"));
            projectIndustries.CreateChildPermission(AppPermissions.Pages_ProjectIndustries_Create, L("CreateNewProjectIndustrie"));
            projectIndustries.CreateChildPermission(AppPermissions.Pages_ProjectIndustries_Edit, L("EditProjectIndustrie"));
            projectIndustries.CreateChildPermission(AppPermissions.Pages_ProjectIndustries_Delete, L("DeleteProjectIndustrie"));
