...
namespace MyCompanyName.AbpZeroTemplate
{
    internal static class CustomDtoMapper
    {
        public static void CreateMappings(IMapperConfigurationExpression configuration)
        {
            ...
            configuration.CreateMap<CreateOrEditProjectStatuDto, ProjectStatu>().ReverseMap();
            configuration.CreateMap<ProjectStatuDto, ProjectStatu>().ReverseMap();
            configuration.CreateMap<CreateOrEditProjectIndustrieDto, ProjectIndustrie>().ReverseMap();
            configuration.CreateMap<ProjectIndustrieDto, ProjectIndustrie>().ReverseMap();
            //Inputs
