...
namespace MyCompanyName.AbpZeroTemplate.Migrations
{
    ...
    [Migration("20220711171901_Regenerated_Project2732")]
    partial class Regenerated_Project2732
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.ProjectIndustries.ProjectIndustrie", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("NameIndustries")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SumaryIndustries")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("ProjectIndustries");
                });

            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.Projects.Project", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ProjectIndustrieId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ProjectStatuId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("TokenShortname")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TotalTokenSupply")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("Whitepaper_URL_FAQ")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("YourEmailaddress")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("ProjectIndustrieId");

                    b.HasIndex("ProjectStatuId");
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.ProjectStatus.ProjectStatu", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("SumaryStatus")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.Projects.Project", b =>
                {
                    b.HasOne("MyCompanyName.AbpZeroTemplate.ProjectIndustries.ProjectIndustrie", "ProjectIndustrieFk")
                        .WithMany()
                        .HasForeignKey("ProjectIndustrieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyCompanyName.AbpZeroTemplate.ProjectStatus.ProjectStatu", "ProjectStatuFk")
                        .WithMany()
                        .HasForeignKey("ProjectStatuId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ProjectIndustrieFk");

                    b.Navigation("ProjectStatuFk");
                });
