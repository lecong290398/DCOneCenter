    ...
    public class AppAreaNameNavigationProvider : NavigationProvider
    {
        ...
        public override void SetNavigation(INavigationProviderContext context)
        {
            ...
            menu
                ...
                .AddItem(new MenuItemDefinition(
                        AppAreaNamePageNames.Common.Projects,
                        L("Projects"),
                        url: "AppAreaName/Projects",
                        icon: "flaticon-more",
                        permissionDependency: new SimplePermissionDependency(AppPermissions.Pages_Projects)
                    )
                )
                .AddItem(new MenuItemDefinition(
                        AppAreaNamePageNames.Common.ProjectStatus,
                        L("ProjectStatus"),
                        url: "AppAreaName/ProjectStatus",
                        icon: "flaticon-more",
                        permissionDependency: new SimplePermissionDependency(AppPermissions.Pages_ProjectStatus)
                    )
                )
                .AddItem(new MenuItemDefinition(
                        AppAreaNamePageNames.Common.ProjectIndustries,
                        L("ProjectIndustries"),
                        url: "AppAreaName/ProjectIndustries",
                        icon: "flaticon-more",
                        permissionDependency: new SimplePermissionDependency(AppPermissions.Pages_ProjectIndustries)
                    )
                ).AddItem(new MenuItemDefinition(
